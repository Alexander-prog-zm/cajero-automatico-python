...
* **Gestión de fondos:** Consulta de saldo actualizado, depósitos de efectivo y retiros automatizados.
* **Validación de retiros:** El sistema verifica si el monto solicitado es menor o igual al saldo disponible para evitar balances negativos.
* **Manejo de errores:** Captura de opciones inválidas en el menú y solicitud de calificación del servicio al cerrar la aplicación.
